...
#IPv4
ip = f"{4:04b}{5:04b}{0:06b}{0:02b}{176+len(tcp):032b}{1:016b}010{0:013b}{64:08b}{6:08b}{0:016b}" \
...
# example server response packet

http = "HTTP/1.1 301 Moved Permanently\nLocation: http://www.homepage.com"
...
ip = f"{4:04b}{5:04b}{0:06b}{0:02b}{160+len(tcp):032b}{1:016b}010{0:013b}{64:08b}{6:08b}{0:016b}" \
     f"{192:08b}{168:08b}{1:08b}{0:08b}{192:08b}{168:08b}{1:08b}{1:08b}{constants.strtobin(tcp)}"
eth = f"{''.join(['0' if i % 2 < 1 else '1' for i in range(56)])}10101011" \
